...
namespace UE
{
	std::string StringfyErrorCode(uint32_t errorCode)
	{
		switch (errorCode)
		{
		...
		case WSA_NOT_ENOUGH_MEMORY:
			return "Insufficient memory avaliable";
		...
		case WSASYSNOTREADY:
			return "Network subsystem is unavaliable";
		case WSAVERNOTSUPPORTED:
			return "Winsock.dll version is out of range";
		...
		case WSANO_DATA:
			return "Invalid name, no data record of requested type";
		...
		case WSA_QOS_EOBJLENGTH:
			return "Invalid QoS object lenght";
		...
		case WSA_QOS_EPSFILTERSPEC:
			return "Invalid QoS provicer-specific filterspec";
